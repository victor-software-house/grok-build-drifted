...
<<<<<<< HEAD:crates/codegen/xai-grok-pager/src/bin/scrollback_search_playground.rs
        // While browsing (accepted), `n` / `N` navigate. While composing they
        // are typed into the query, matching real vim `/` behavior.
=======
        // While browsing (accepted), `n` / `N` navigate
        // While composing they are typed into the query, matching real vim `/` behavior
>>>>>>> 72a61251fcffb464bcc687aeb5a998e5a98ec0c9:crates/codegen/xai-grok-pager/examples/scrollback_search_playground.rs
...
fn draw(f: &mut ratatui::Frame, app: &mut App) {
    ...
    let chunks = Layout::vertical([
        ...
        Constraint::Length(14), // scrollback and search bar
